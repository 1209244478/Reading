package com.wrz.reading.ui.main.popupView;
 ...
 */
public class WeightChangePopup extends ConfirmPopupView implements View.OnClickListener {

    /**
     * @param context
     * @param bindLayoutId 在Confirm弹窗基础上需要增加一个id为et_input的EditText
     */
    public WeightChangePopup(@NonNull Context context, int bindLayoutId,
                             String title, String hint, String inputContent,
