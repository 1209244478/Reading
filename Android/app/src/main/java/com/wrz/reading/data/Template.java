...
public class Template {
    ...
    public List<Option> getDefaultList() {
        ...
        /*defaultList.add(new Option("海底捞"));
        defaultList.add(new Option("火锅"));
        defaultList.add(new Option("烧烤"));
        defaultList.add(new Option("披萨"));
        defaultList.add(new Option("汉堡"));
        defaultList.add(new Option("寿司"));
        defaultList.add(new Option("麻辣烫"));
        defaultList.add(new Option("川菜"));
        defaultList.add(new Option("粤菜"));
        defaultList.add(new Option("韩餐"));*/
        // 使用资源字符串代替硬编码
